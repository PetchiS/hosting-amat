...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_10__["HomeComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_6__["MatInputModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__["BrowserAnimationsModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_8__["MatButtonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["FormsModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_11__["MatSnackBarModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_12__["MatCardModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_13__["MatIconModule"]],
      providers: [],
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _login_authentication_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(snackbar, authService, router) {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          if (this.authService.accessAll) this.isOthers = false;else this.isOthers = true;
        }
      }, {
        key: "addFruit",
        value: function addFruit(card, all) {
          var _this = this;

          all.map(function (fruit) {
            if (fruit.text === card.text) {
              if (fruit.number >= 0 && fruit.number < 10) {
                _this.displayCard = true;
                fruit.number = parseInt(fruit.number) + 1;

                _this.updateStack(fruit.color, 'add');
              } else {
                _this.snackbar.open("Maxmimun quantity reached", "Warning", {
                  duration: 2000
                });
              }
            }
        ...
        key: "removeFruit",
        value: function removeFruit(card, all) {
          var _this2 = this;
          ...
          all.map(function (fruit) {
            if (fruit.text === card.text) {
              if (fruit.number > 0) {
                ...
                _this2.updateStack(fruit.color, 'remove');
              } else {
                _this2.snackbar.open("No item to remove", "Warning", {
                  duration: 2000
                });
              }
            }
        ...
        key: "updateStack",
        value: function updateStack(color, condition) {
          if (condition === 'add') {
            this.stack.push(color);
          } else {
            if (this.stack.indexOf(color) > -1) {
              var index = this.stack.lastIndexOf(color);
    ...
    HomeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      selector: 'app-home',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
  ...
  function srcAppLoginAuthenticationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthenticationService = /*#__PURE__*/function () {
      ...
      _createClass(AuthenticationService, [{
        key: "authenticate",
        value: function authenticate(un, pw) {
